...
def send_test_email_smtp():
    ...
    <body>
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="https://proximity-search-8.preview.emergentagent.com/guest/test-demo" 
                   class="button"
                   style="color: white;">
                    💬 Try the AI Chatbot
                </a>
    ...
    print(f"🔗 Chatbot Link: https://proximity-search-8.preview.emergentagent.com/guest/test-demo")
